...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/ChefinhoBR/script/master/versao
...
echo -e "                              \033[1;31mBy Red YT\033[1;36m"
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@redssh_oficial\n"
  ...
  echo -e "  \033[1;33mMAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@redytvpn\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget http://sv.bigbolgames.com:8444/files/superuser/redyt/redyt > /dev/null 2>&1

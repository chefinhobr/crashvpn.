...
[[ ! -e /usr/lib/redyt ]] && rm -rf /bin/menu > /dev/null 2>&1
...
#menu2
menu2 (){
[[ -e /etc/redyt-torrent ]] && stsf=$(echo -e "\033[1;32m◉ ") || stsf=$(echo -e "\033[1;31m○ ")
...
[[ "$(cat /etc/redyt/Exp)" != "" ]] && _expuser=$(cat /etc/redyt/Exp) || _expuser="0"
...
clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\E[41;1;37m            Red YT MANAGER ⇲                \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"

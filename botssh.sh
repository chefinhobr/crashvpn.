...
fun_botOnOff() {
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) = '0' ]] && {
        clear
        echo -e "\E[44;1;37m             INSTALADOR BOT redyt                \E[0m\n"
        ...
        read iduser
        clear
        echo -e "\033[1;32mINICIANDO BOT REDSSH \033[0m\n"
        fun_bot1() {
            [[ ! -e "/etc/redyt/ShellBot.sh" ]] && wget https://raw.githubusercontent.com/ChefinhoBR/script/master/ShellBot.sh -O /etc/redyt/ShellBot.sh
            cd /etc/redyt
			rm -R bot
			wget https://raw.githubusercontent.com/ChefinhoBR/script/master/bot
			chmod 777 bot
            screen -dmS bot_plus ./bot $tokenbot $iduser >/dev/null 2>&1
            [[ $(grep -wc "bot_plus" /etc/autostart) = '0' ]] && {
                echo -e "ps x | grep 'bot_plus' | grep -v 'grep' || cd /etc/redyt && sudo screen -dmS bot_plus ./bot $tokenbot $iduser && cd $HOME" >>/etc/autostart
            } || {
        ...
        fun_bar 'fun_bot2'
        echo -e "\n\033[1;32m \033[1;31mBOT REDSSH PARADO! \033[0m"
        sleep 2
        menu
    }
}
...
fun_instbot() {
    echo -e "\E[44;1;37m             INSTALADOR BOT REDSSH                \E[0m\n"
    ...
    echo -e "\n\033[1;32m3° \033[1;37m- \033[1;33mBOT \033[1;37m@encarregado_bot \033[1;33mDIGITE /id E PEGUE SEU ID \033[1;31mOPCAO: \033[1;37m/id\033[0m"
...
[[ -f "/etc/redyt/ShellBot.sh" ]] && fun_botOnOff || fun_instbot
#fim

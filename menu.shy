...
[[ ! -e /usr/lib/script ]] && rm -rf /bin/menu > /dev/null 2>&1
...
#menu2
menu2 (){
[[ -e /etc/script-torrent ]] && stsf=$(echo -e "\033[1;32m◉ ") || stsf=$(echo -e "\033[1;31m○ ")
...
[[ "$(cat /etc/script/Exp)" != "" ]] && _expuser=$(cat /etc/script/Exp) || _expuser="0"
...
clear
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\E[41;1;37m            PAINEL REDSSH ⇲                \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
[\033[1;36m10\033[1;31m] \033[1;37m• \033[1;33mMODO DE CONEXAO \033[1;31m          [\033[1;36m20\033[1;31m] \033[1;37m• \033[1;33mEM BREVE \033[1;31m
...
case "$x" in 
   ...
   20)
   clear
   echo "JA DISSE QUE E EM BREVE PESTE SOME DAQUI >:( "
   sleep 2
   menu
   ;;
   21)
